...
data/svc_ek1_2011_2024.joblib, trained only on years 2011-2024 (built
by ai-tools/ai_experiments/pre2025/build_pre2025_model.py).
"""
...
def schedule(features, total_cores):
    ...
    model_path = os.path.join(script_dir, "data", "svc_ek1_2011_2024.joblib")
...
def main():
    ...
    portfolio = "cpsat" if len(sched) == 1 else "ek1"
