#!/bin/bash
set -eo pipefail
source /work/minizinc/scripts/setup-env.sh --gurobi-license /work/minizinc/solvers/gurobi/gurobi-mikkel.lic
...
year=2020
rep=1
export HELD_OUT_YEAR=2020

{
    echo "=== ${PORTFOLIO} ${year} r${rep} (license=mikkel) ==="
